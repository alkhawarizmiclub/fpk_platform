...
const Header = () => {
    return (
        <header className="relative h-screen flex flex-col bg-cover bg-norepeat bg-top">
            <Navbar />
            <div className="z-1 pt-5 pb-10 px-10 grow flex flex-col justify-center items-start gap-4 text-white bg-gradient-to-r from-blue-800/70 from-40%">
