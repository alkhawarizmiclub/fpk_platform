const Activity = ({ label, url, img_src }) => {
    return (
        <div className="relative group flex justify-center items-center rounded-lg aspect-[4/3] overflow-hidden bg-slate-200">
            ...
            <a href={url} className="absolute bottom-0 p-5 flex flex-col justify-center w-full h-20 group-hover:h-full transition-all duration-300 text-white bg-orange-400/50 backdrop-blur">
